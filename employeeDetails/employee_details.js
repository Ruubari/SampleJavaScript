...
function findSpecialization(specialization) {
    ...
    if (foundSpecialization) {
        document.getElementById('employeesDetails').innerHTML = `<p>${foundSpecialization.id}: ${foundSpecialization.name}: ${foundSpecialization.age} - ${foundSpecialization.department} - $${foundSpecialization.salary}</p>`;
    }else {
        document.getElementById('employeesDetails').innerHTML = 'No employee specialization found';
    }
